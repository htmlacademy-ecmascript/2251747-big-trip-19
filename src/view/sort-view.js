...
function createSortTemplate(currentSortType) {
  return (
    ...
    <div class="trip-sort__item  trip-sort__item--day">
      ...
      <label class="trip-sort__btn ${currentSortType === SortType.DAY ? 'board__sort-item--active' : ''}" for="sort-day" data-sort-type="${SortType.DAY}">Day</label>
    </div>
    ...
    <div class="trip-sort__item  trip-sort__item--time">
      ...
      <label class="trip-sort__btn ${currentSortType === SortType.TIME ? 'board__sort-item--active' : ''}" for="sort-time" data-sort-type="${SortType.TIME}">Time</label>
    </div>
    ...
    <div class="trip-sort__item  trip-sort__item--price">
      ...
      <label class="trip-sort__btn ${currentSortType === SortType.PRICE ? 'board__sort-item--active' : ''}" for="sort-price" data-sort-type="${SortType.PRICE}">Price</label>
    </div>
